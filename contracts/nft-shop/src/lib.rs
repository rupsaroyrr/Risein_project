#![no_std]
use soroban_sdk::{contract, contractimpl, contractclient, contracttype, Address, Env, String};

// Declare the interface for the StellarNFT contract for Inter-Contract Communication (ICC)
#[contractclient(name = "StellarNftClient")]
pub trait StellarNftInterface {
    fn mint(env: Env, to: Address, id: u32, metadata: String);
    fn transfer(env: Env, from: Address, to: Address, id: u32);
    fn owner_of(env: Env, id: u32) -> Address;
    fn get_metadata(env: Env, id: u32) -> String;
    fn burn(env: Env, id: u32);
}
...
pub enum DataKey {
    ...
    NftContract,
    XlmToken,
    UsdToXlmRate, // Simulated rate for conversion ($1 = usd_rate XLM)
}
...
impl NFTShop {
    ...
    pub fn buy_nft(env: Env, buyer: Address, nft_id: u32, metadata: String, price_usd: u32) {
        ...
        let nft_client = StellarNftClient::new(&env, &nft_contract_id);
